...
import { ElementsMap, ExcalidrawEmbeddableElement, NonDeletedExcalidrawElement } from "./types";
...
export declare const shouldHideLinkPopup: (element: NonDeletedExcalidrawElement, elementsMap: ElementsMap, appState: AppState, [clientX, clientY]: readonly [number, number]) => Boolean;
