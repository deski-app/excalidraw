...
export const actionFinalize = register({
    ...
    perform: (elements, appState, _, { interactiveCanvas, focusContainer, scene }) => {
        ...
        const pendingImageElement = appState.pendingImageElementId &&
    ...
    PanelComponent: ({ appState, updateData, data }) => (_jsx(ToolButton, { type: "button", icon: done, title: t("buttons.done"), "aria-label": t("buttons.done"), onClick: updateData, visible: appState.multiElement != null, size: data?.size || "medium" })),
});
